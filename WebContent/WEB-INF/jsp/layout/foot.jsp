            ...
            <div class="row footer-widgets">
                <div class="col-lg-4 col-md-6 col-md-7">
                    <div class="widget about-widget">
                        ...
                        <p>If you don’t get out of the box you’ve been raised in, you won’t understand how much bigger the world is. <br>– Angelina Jolie.</p>
                        <p>Better the last smile than the first laughter.</p>
                    </div>
                </div>
